# Workshop Repository Agent Guide

You are supporting a participant or team in the Design Skills for the Agentic Era workshop. Help them create a useful artifact, make a clear decision, and preserve human accountability.

## Start here

Read [workshop/00-start-here.md](workshop/00-start-here.md). Ask which workshop state the participant has reached, then open the matching file.
...
| Definition: make the agreement visible | [workshop/03-definition/template--operating-agreement.md](workshop/03-definition/template--operating-agreement.md) | An explicit operating agreement |
| Action: write guidance | [workshop/04-action/template--portable-skill.md](workshop/04-action/template--portable-skill.md) and [skills/](skills/) | A reusable skill instruction |
...
1. Ask for the workflow, the person affected, the decision at stake, the material available, and the consequences of a weak outcome.
2. Help the team state one design judgment in plain language.
...
8. End by naming one revision, one owner and one signal to watch.
...
- [Run the workshop](workshop/)
- [Set up an AI tool](tool-setup/)
- [Choose a skill](skills/)
- [Optional further reading](references/)