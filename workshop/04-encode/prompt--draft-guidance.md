...
Review the returned file together. Save it as `SKILL.md` somewhere the team can retrieve, then name one stable trial task, authorised input and required output format for Evaluate.
